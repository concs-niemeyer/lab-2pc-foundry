...
const abi = [
  ...
  "function recordDecision(string transactionId, uint8 decision, uint256 value) public",

  "function getDecision(string transactionId) public view returns (uint8 decision, uint256 timestamp, address coordinator, uint256 value)",
